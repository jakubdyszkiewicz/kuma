...
var (
	...
	_ = PDescribe("Mesh External Services", meshexternalservice.MeshExternalService, Ordered)
	_ = PDescribe("MeshService", meshservice.MeshService, Ordered)
	...
	_ = PDescribe("Traffic Permission", trafficpermission.TrafficPermission, Ordered)
	...
	_ = PDescribe("Mesh Traffic Permission", meshtrafficpermission.MeshTrafficPermissionUniversal, Ordered)
	...
	_ = PDescribe("Compatibility", compatibility.UniversalCompatibility, Ordered)
	_ = PDescribe("Resilience", resilience.ResilienceUniversal, Ordered)
	...
	_ = PDescribe("MeshLoadBalancingStrategy", meshloadbalancingstrategy.Policy, Ordered)
	_ = PDescribe("InterCP Server", intercp.InterCP, Ordered)
	_ = PDescribe("Prometheus Metrics", observability.PrometheusMetrics, Ordered)
	_ = PDescribe("MeshTLS", meshtls.Policy, Ordered)
)
