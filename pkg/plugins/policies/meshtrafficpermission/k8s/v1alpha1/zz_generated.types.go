...
func (cb *MeshTrafficPermission) GetSpec() (proto.Message, error) {
	return cb.Spec, nil
}

func (cb *MeshTrafficPermission) SetSpec(spec proto.Message) {
	if spec == nil {
		cb.Spec = nil
		return
	}
...
func init() {
	...
	registry.RegisterObjectType(policy.MeshTrafficPermissionType, &MeshTrafficPermission{
		TypeMeta: metav1.TypeMeta{
			APIVersion: GroupVersion.String(),
			Kind:       "MeshTrafficPermission",
		},
	})
	registry.RegisterListType(policy.MeshTrafficPermissionType, &MeshTrafficPermissionList{
		TypeMeta: metav1.TypeMeta{
			APIVersion: GroupVersion.String(),
